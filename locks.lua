...
if not msg.SudoBase then return "🚸*┇*هذا الامر يخص المطور الاساسي اترك اللقافه\n💥" end
...
if not msg.SudoBase then return "📡*┇*هذا الامر يخص المطور اترك اللقافه💥" end
...
if not msg.Admin then return "📡*┇*هذا الامر يخص الادمنيه اترك اللقافه💥" end
