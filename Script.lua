...
function download_to_file(url, file_name)
  ...
  if code ~= 500 then return nil end
...
return "📛*│* هذا الامر يخص {المدير,المنشئ,المطور} اترك اللقافه\n🚶"
end
...
if not msg.Creator then return "📛*│* هذا الامر يخص {المنشئ,المطور} اترك اللقافه\n🚶"
end
...
if not msg.Admin then return "♦️*│*هذا الامر يخص {الادمن,المدير,المنشئ,المطور} اترك اللقافه\n💥"
end
redis:set(max..'lock:karaa:'..msg.chat_id_,'on')
return "🙋🏼‍♂️*╿* أهلا عزيزي "..msg.TheRankCmd.."\n📡*╽* تم تعطيل التسليه \n✓"
end
function cmdss_off(msg)
if not msg.SudoUser then return "♦️*│*هذا الامر يخص {المطور} اترك اللقافه  \n💥"
end
...
if not msg.Admin then return "📛*│* هذا الامر يخص {الادمن,المدير,المنشئ,المطور} اترك اللقافه  \n🚶"
end
...
if not msg.Director then return "♦️*│*هذا الامر يخص {المطور,المنشئ,المدير } اترك اللقافه  \n💥" end
...
if not msg.Creator then return "♦️*│*هذا الامر يخص {المطور,المنشئ } اترك اللقافه  \n💥" end
if not MsgText[2] and msg.reply_id then
if redis:get(max..'lock:kara:'..msg.chat_id_) == 'off' then
...
if not msg.SudoUser then return "♦️*│*هذا الامر يخص {المطور,المطور الاساسياترك اللقافه  \n💥" end
if not MsgText[2] and msg.reply_id then 
...
if not msg.Kara then return "♦️*│*هذا الامر يخص {المنشئ الاساسي,المطور,المطور الاساسياترك اللقافه  \n💥" end
if not MsgText[2] and msg.reply_id then
...
if not msg.Kara then return "♦️*│*هذا الامر يخص {المطور,المنشى الاساسي فقطاترك اللقافه  \n💥" end
if not MsgText[2] and msg.reply_id then
...
if not msg.SudoUser then return "♦️*│*هذا الامر يخص أبو ليلى اترك اللقافه  \n💥"
if not msg.Rank then end
if not MsgText[2] and msg.reply_id then
if redis:get(max..'lock:karaa:'..msg.chat_id_) == 'off' then
...
if not msg.SudoUser then return "♦️*│*هذا الامر يخص {} اترك اللقافه  \n💥" end
...
if not msg.Creator then return "♦️*│*هذا الامر يخص {المطور,المنشئ,المدير } اترك اللقافه  \n🚶" end
local NumMDER = redis:scard(max..'owners:'..msg.chat_id_)
if NumMDER ==0 then 
...
if not msg.Director then return "♦️*│*هذا الامر يخص {المطور,المنشئ } اترك اللقافه  \n💥" end
...
if not msg.SudoBase then return"♦️*│*هذا الامر يخص {المطور الاساسياترك اللقافه  \n💥" end
...
if not msg.SudoBase then return "♦️*│*هذا الامر يخص {المطور الاساسي 👨‍💻اترك اللقافه  \n💥" end
if not MsgText[2] and msg.reply_id then 
...
if not msg.SudoBase then return "♦️*│*هذا الامر يخص {} اترك اللقافه  \n💥" end
...
return "♦️*│*هذا الامر يخص أبو ليلى اترك اللقافه  \n💥" 
end
...
if not msg.SudoBase then return"♦️*│*هذا الامر يخص أبو ليلى اترك اللقافه  \n💥" end
...
return '👨🏾‍🔧│ اصدار سورس بيسو : *v'..version..'* \n📡'
end

if (MsgText[1] == 'تحديث السورس' or MsgText[1] == 'تحديث السورس 🔂') then
if not msg.SudoBase then return "♦️*│*هذا الامر يخص {المطور الاساسياترك اللقافه  \n💥" end
local GetVerison = https.request('https://githubcom/MasSource/MAS.github.io/GetVersion.t') or 0
...
send_key(msg.sender_user_id_,'  [⚜│قناة سورس : بيسو](t.me/b1Nashi)',nil,inline,msg.id_)
return false
end
...
⁦🙋🏻‍♂️⁩ | مطور السورس : @nashi080

📡 | القناة الخاصة بالسورس : @b1Nashi
...
if not msg.Kara then return "♦️*│*هذا الامر يخص {المنشئ الاساسي,المطور,المطور} الاساسي اترك اللقافه  \n💥" end
...
local ns = {
"أسمي ["..Bot_Name.."] ياقلبي",
"نادني ب ["..Bot_Name.."] يالغالي",
"مكتوب اسمي ["..Bot_Name.."] ماتعرف تقرا ",
"بوت بعينك يازفت ",
"اسمي ["..Bot_Name.."] ",
"انت البوت ",
 "شعندك تناديني بوت ",
...
elseif Text:match("^قووووعل (.*)$") then
...
elseif Text=="نايمتخهتين؟" then 
return sendMsg(msg.chat_id_,msg.id_,nm[math.random(#nm)])
elseif Text=="نمتتهتو" then 
return sendMsg(msg.chat_id_,msg.id_,nm[math.random(#nm)])
elseif Text=="نمتتهختهخو؟" then 
return sendMsg(msg.chat_id_,msg.id_,nm[math.random(#nm)])
elseif Text=="مساء الحختحخخير" then 
return sendMsg(msg.chat_id_,msg.id_,msx[math.random(#msx)])
elseif Text=="صباح النحنحخنخنحخير" then 
return sendMsg(msg.chat_id_,msg.id_,smx[math.random(#smx)])
elseif Text=="مننخنخور" then 
return sendMsg(msg.chat_id_,msg.id_,nor[math.random(#nor)])
elseif Text=="منوخننخره" then 
return sendMsg(msg.chat_id_,msg.id_,nor[math.random(#nor)])
elseif Text=="بنننخحام" then 
return sendMsg(msg.chat_id_,msg.id_,nmf[math.random(#nmf)])
elseif Text=="ياحخنخنخياتي" then 
return sendMsg(msg.chat_id_,msg.id_,amr[math.random(#amr)])
elseif Text=="ياعمنخنخنري" then 
return sendMsg(msg.chat_id_,msg.id_,amr[math.random(#amr)])
elseif Text=="ياقلنخنخنخبي" then 
return sendMsg(msg.chat_id_,msg.id_,amr[math.random(#amr)])
elseif Text=="اعشنخنخنخقك" then 
return sendMsg(msg.chat_id_,msg.id_,amr[math.random(#amr)])
elseif Text=="مرخنخنخحبا" then 
return sendMsg(msg.chat_id_,msg.id_,mrr[math.random(#mrr)])
elseif msg.SudoUser and Text== "تحبنخنخنني" or Text=="حبك" then 
return sendMsg(msg.chat_id_,msg.id_,"اعشنخنخنخقنك ")
elseif not msg.SudoUser and Text== "احبنخنخنك" or Text=="حبنخنخنك" then 
return sendMsg(msg.chat_id_,msg.id_,lovm[math.random(#lovm)])
elseif not msg.SudoUser and Text== "تحبننخنخنخي" then
return sendMsg(msg.chat_id_,msg.id_,lovm[math.random(#lovm)])
...
return sendMsg(msg.chat_id_,msg.id_," وعليكم السلام ورحمة الله وبركاته")
...
elseif Text== "رفع زووووجتي" then return sendMsg(msg.chat_id_,msg.id_,"🙋🏻‍♂┇اهــلا عزيزي\n🎫┇تم رفع العضو زوجتك بنجاح✔️\nالآن يمكنكم أخذ راحتكم🤤??\n✓️")
elseif Text== "طلااااق" then return sendMsg(msg.chat_id_,msg.id_,"🙋🏻‍♂┇اهــلا عزيزي\n🎫┇تم طلاق العضو بنجاح✔️\n🛠┇الآن هو مطلق يله انقلع برا 😹💔\n✓️")
...
elseif Text== "تنزيل زووووجتي" then return sendMsg(msg.chat_id_,msg.id_,"🙋🏻‍♂┇اهــلا عزيزي\n🎫┇تم تنزيل الرمه زوجتك بنجاح✔️\nالآن انتم مفترقان☹️💔\n✓️")
elseif Text== "زوااااج" then return sendMsg(msg.chat_id_,msg.id_,"🙋🏻‍♂┇اهــلا عزيزي\n🎫┇تم زواجكم الاثنين بنجاح✔️\n🛠┇الآن يمكنكم أخذ راحتكم🤤😉\n✓️")
elseif Text== "رفع زووووجي" then return sendMsg(msg.chat_id_,msg.id_,"🙋🏻‍♂┇اهــلا عزيزي\n🎫┇تم رفع العضو زوجك بنجاح✔️\nالآن يمكنكم أخذ راحتكم🤤😉\n✓️")
elseif Text== "تنزيل زووووجي" then return sendMsg(msg.chat_id_,msg.id_,"🙋🏻‍♂┇اهــلا عزيزي\n🎫┇تم تنزيل الرم زوجك بنجاح✔️\nالآن انتم مفترقان☹️💔\n✓️")
...
--=====================================
elseif Text== "انا مين" or Text== "من انا" or Text=="انا منو" then
